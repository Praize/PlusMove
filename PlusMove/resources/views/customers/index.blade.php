<x-app-layout>
    <div class="flex h-screen bg-gray-100">
        ...
        <div class="flex flex-col flex-1 overflow-y-auto">
            ...
            <div class="p-4">
                <h2 class="text-2xl font-bold">Customer Section</h2>
                ...
                <div class="float-right mb-3">
                    <a  class="cursor-pointer rounded-lg bg-blue-700 px-4 py-2 text-sm font-semibold text-white"href="{{ route('customers.create') }}"> Create New Customer</a>
                </div>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0 h-10 w-10">
                                            <img class="h-10 w-10 rounded-full" src="https://img.freepik.com/premium-vector/default-avatar-profile-icon-social-media-user-image-gray-avatar-icon-blank-profile-silhouette-vector-illustration_561158-3407.jpg?w=360" alt="">
                                        </div>
                                        <div class="ml-4">
