<x-app-layout>
    <div class="flex h-screen bg-gray-100">
        ...
        <div class="flex flex-col flex-1 overflow-y-auto">
            ...
            <div class="p-4">
                <h2 class="text-2xl font-bold">Driver Save</h2>
                <div class="row">
                    <div class="pull-left">
                ...
                <form class="mx-14 mt-10 border-2 border-blue-400 rounded-lg" action="{{ route('drivers.store') }}" method="POST">
                    ...
                    <div class="p-8">
                      <div class="flex gap-4">
                        <input type="text" name="driver_name" class="mt-1 block w-1/2 rounded-md border border-slate-300 bg-white px-3 py-4 placeholder-slate-400 shadow-sm placeholder:font-semibold placeholder:text-gray-500 focus:border-sky-500 focus:outline-none focus:ring-1 focus:ring-sky-500 sm:text-sm" placeholder="Drivers Name *" />
                        <input type="email" name="driver_email"  class="mt-1 block w-1/2 rounded-md border border-slate-300 bg-white px-3 py-4 placeholder-slate-400 shadow-sm placeholder:font-semibold placeholder:text-gray-500 focus:border-sky-500 focus:outline-none focus:ring-1 focus:ring-sky-500 sm:text-sm" placeholder="Drivers Email *" />
                      </div>

                      <div class="my-6 flex gap-4">
                        <input type="text" name="driver_phonenumber" class="mt-1 block w-1/2 rounded-md border border-slate-300 bg-white px-3 py-4 placeholder-slate-400 shadow-sm placeholder:font-semibold placeholder:text-gray-500 focus:border-sky-500 focus:outline-none focus:ring-1 focus:ring-sky-500 sm:text-sm" placeholder="eg. +27835001111 *" />
