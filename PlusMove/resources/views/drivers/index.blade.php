<x-app-layout>
    <div class="flex h-screen bg-gray-100">
        ...
        <div class="flex flex-col flex-1 overflow-y-auto">
            ...
            <div class="p-4">
                <h2 class="text-2xl font-bold">Driver Section</h2>
                ...
                <div class="float-right mb-3">
                    <a  class="cursor-pointer rounded-lg bg-blue-700 px-4 py-2 text-sm font-semibold text-white" href="{{ route('drivers.create') }}"> Create New Driver</a>
                </div>
                            ...
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0 h-10 w-10">
                                            <img class="h-10 w-10 rounded-full" src="https://icons.iconarchive.com/icons/icons8/windows-8/256/Transport-Driver-icon.png" alt="">
                                        </div>
                                        <div class="ml-4">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap  text-sm font-medium">
                                    ...
                                    <form action="{{ route('drivers.destroy',$driver->id) }}" method="POST">
                                        ...
                                        <a  href="{{ route('drivers.edit',$driver->id) }}" class="text-indigo-600 hover:text-indigo-900">Edit</a>
                                        ...
                                        <a  href="{{ route('drivers.show',$driver->id) }}" class="text-blue-600 hover:text-blue-900">Assign</a>
