<x-app-layout>
    <div class="flex h-screen bg-gray-100">
        ...
        <div class="flex flex-col flex-1 overflow-y-auto">
            ...
            <div class="p-4">
                <h2 class="text-2xl font-bold">Package Edit</h2>
                <div class="row">
                    <div class="pull-left">
                ...
                <form class="mx-14 mt-10 border-2 border-blue-400 rounded-lg" action="{{ route('packages.update', $packages->id) }}" method="POST">
                    ...
                    <div class="p-8">
                      <div class="flex gap-4">
                        <input type="text" name="package_name" value="{{ $packages->package_name }}" class="mt-1 block w-1/2 rounded-md border border-slate-300 bg-white px-3 py-4 placeholder-slate-400 shadow-sm placeholder:font-semibold placeholder:text-gray-500 focus:border-sky-500 focus:outline-none focus:ring-1 focus:ring-sky-500 sm:text-sm" placeholder="Package Name *"  />
                        <input type="email" name="package_weight" value="{{ $packages->package_weight }}" class="mt-1 block w-1/2 rounded-md border border-slate-300 bg-white px-3 py-4 placeholder-slate-400 shadow-sm placeholder:font-semibold placeholder:text-gray-500 focus:border-sky-500 focus:outline-none focus:ring-1 focus:ring-sky-500 sm:text-sm" placeholder="Weight in Kg. *" />
                      </div>
                      ...
                      <div class="my-6 flex gap-4">
                        <select name="is_active" id="select" value="{{ $packages->is_active }}" class="block w-1/2 rounded-md border border-slate-300 bg-white px-3 py-4 font-semibold text-gray-500 shadow-sm focus:border-sky-500 focus:outline-none focus:ring-1 focus:ring-sky-500 sm:text-sm">
